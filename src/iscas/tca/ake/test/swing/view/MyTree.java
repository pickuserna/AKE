...
public class MyTree extends JFrame {
    ...
    public void addToTree(String value){
    	
    }
    public void readXML2Tree(String xmlPath){
    	//XMLTools xml = new XMLTools(xmlPath, "config");
    	//xml.getDocument();
    }
    //设置当前窗口的信息
    private void init() {
    ...
    private void popMenuInit() {
        ...
        JMenuItem modifyItem = new JMenuItem("change");
    ...
    class TreeDeleteViewMenuEvent implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            int conform = JOptionPane.showConfirmDialog(null, "confirm", "confirm", JOptionPane.YES_NO_OPTION);
...
class TreeModifyViewMenuEvent implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        String name = JOptionPane.showInputDialog("input the value");
